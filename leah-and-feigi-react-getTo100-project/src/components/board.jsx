...
function Board(props) {
    ...
    return (<>
        <div className="bord">
            ...
            <OperationsButtons steps={steps} player={props.player} setUserDetails={props.setUserDetails} number={number} setSteps={setSteps} availableBord={props.availableBord} setNumber={setNumber} setAvailableBord={props.setAvailableBord} length={props.length} index={props.index} />
